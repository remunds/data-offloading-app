...
class AboutNature40 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Text> _nature40 = [];
    _stringsNature40
        .forEach((string) => _nature40.add(Text(string, style: textStyle)));
    ...
    return Card(
      child: Column(
        children: [
          ...
          _textfield(_nature40[2]),
          _title(' Mehr Informationen und Kontakt ', 18.0),
          _textfield(_nature40[3]),
          Row(
            children: [
              TextButton(
                onPressed: () {
